...
@Component({
  selector: 'app-loginattemptpassword',
  templateUrl: './loginattemptpassword.component.html',
  styleUrls: ['./loginattemptpassword.component.scss']
})
export class LoginattemptpasswordComponent implements OnInit {
